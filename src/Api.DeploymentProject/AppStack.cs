...
using Api.DeploymentProject.Configurations;
...
namespace Api.DeploymentProject
{
    public class AppStack : Stack
    {
            ...
            : base(scope, props.StackName, props)
        {
            ...
            var locationsTable = new Table(this, "StarbucksLocations", tableProps);
            
            locationsTable.AddGlobalSecondaryIndex(new GlobalSecondaryIndexProps {
            ...
            locationsTable.GrantFullAccess(generatedRecipe.TaskRole);
